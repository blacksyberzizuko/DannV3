# Baileys - Typescript/Javascript WhatsApp Web API
 ...
 If you're interested in building a WhatsApp bot, you may wanna check out [WhatsAppInfoBot](https://github.com/danncoding/WhatsappInfoBot) and an actual bot built with it, [Messcat](https://github.com/ashokatechmin/Messcat).
 
 **Read the docs [here](https://danncoding.github.io/Baileys)**
 **Join the Discord [here](https://discord.gg/WeJM5FP9GG)**

## Example

Do check out & run [example.ts](https://github.com/danncoding/Baileys/blob/master/Example/example.ts) to see an example usage of the library.
...
```
yarn add danncoding/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:danncoding/baileys
```

Then import your code using:
``` ts 
// for multi-device
import makeWASocket from 'danncoding/baileys'
// for legacy web
import {makeWALegacySocket} from 'danncoding/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'danncoding/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'danncoding/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from 'danncoding/baileys'
...
import { AnyWASocket } from 'danncoding/baileys'
```
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'danncoding/baileys'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/danncoding/Baileys'}},
...
``` ts
// send a link
const sentMsg  = await sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/danncoding/baileys' })
```
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from 'danncoding/baileys'
                                */
...
import { downloadMediaMessage } from 'danncoding/baileys'
